...
static vid_mode_t modes[NUM_MODES] = {
    WINDOWED_MODE(320, 240),     WINDOWED_MODE(640, 480),
    WINDOWED_MODE(800, 600),     FULLSCREEN_MODE(320, 200),
    FULLSCREEN_MODE(320, 240),   FULLSCREEN_MODE(640, 400),
    FULLSCREEN_MODE(640, 480),   FULLSCREEN_MODE(800, 600),
    FULLSCREEN_MODE(1024, 768),  FULLSCREEN_MODE(1152, 864),
    FULLSCREEN_MODE(1280, 720),  FULLSCREEN_MODE(1280, 768),
    FULLSCREEN_MODE(1280, 800),  FULLSCREEN_MODE(1280, 960),
