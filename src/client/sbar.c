...
void Sbar_DrawSubPic(int x, int y, qpic_t* pic, int srcx, int srcy, int width,
                     int height) {
...
void Sbar_TeamOverlay(void) {
    ...
    Draw_String(
        x, y,
        "\x1d\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1f \x1d\x1e\x1e\x1f "
        "\x1d\x1e\x1e\x1e\x1f \x1d\x1e\x1e\x1e\x1e\x1e\x1f");
    y += 8;
    ...
    for (i = 0; i < scoreboardteams && y <= vid.height - 10; i++) {
        ...
        if (!strncmp(
                Info_ValueForKey(cl.players[cl.playernum].userinfo, "team"),
                tm->team, 16)) {
...
void Sbar_DeathmatchOverlay(int start) {
    ...
    if (teamplay) {
        ...
        Draw_String(
            x, y,
            "\x1d\x1e\x1e\x1f \x1d\x1f \x1d\x1e\x1e\x1f \x1d\x1e\x1e\x1e\x1f "
            "\x1d\x1e\x1e\x1f "
            "\x1d\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1e\x1f");
        y += 8;
    } else {
        x = 16;
        //                            0    40 64   104   152
