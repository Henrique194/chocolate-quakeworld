...
typedef struct {
    ...
    vec3_t origin;
    // only for demos, not from server
    vec3_t viewangles;
    vec3_t velocity;
    int weaponframe;
...
typedef struct {
    ...
    player_state_t playerstate
        [MAX_CLIENTS]; // message received that reflects performing the usercmd
...
extern int cl_oldnumvisedicts;
extern entity_t* cl_visedicts;
extern entity_t* cl_oldvisedicts;
